        ...
        <div>
          ...
          <div className="mt-16 px-6 w-full flex items-end justify-between">
            <p className="text-xl max-w-xl text-slate-700">
              ...
              error, ipsam earum inventore illum veritatis nulla aperiam. Vitae
              excepturi alias earum esse incidunt, quibusdam cum, temporibus
              sint aliquam inventore voluptas?
            </p>
            <button
        ...
        <div className="border-t-2 border-white-800 px-6 mt-16 mx-auto">
          ...
          <div className="mt-16 flex flex-col gap-24 w-1/3">
            <div className="w-full flex gap-4">
              ...
              <div>
                <h3 className="font-semibold text-[20px]">Bianco Biancov</h3>
